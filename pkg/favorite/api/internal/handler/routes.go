...
import (
	...
	feed "douyin/pkg/favorite/api/internal/handler/feed"
	publish "douyin/pkg/favorite/api/internal/handler/publish"
	user "douyin/pkg/favorite/api/internal/handler/user"
