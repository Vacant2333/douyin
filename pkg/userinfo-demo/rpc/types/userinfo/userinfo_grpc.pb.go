...
func (c *userinfoClient) GetUser(ctx context.Context, in *UserinfoRequest, opts ...grpc.CallOption) (*UserinfoResult, error) {
...
type UserinfoServer interface {
	GetUser(context.Context, *UserinfoRequest) (*UserinfoResult, error)
...
func (UnimplementedUserinfoServer) GetUser(context.Context, *UserinfoRequest) (*UserinfoResult, error) {
...
func _Userinfo_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserinfoServer).GetUser(ctx, req.(*UserinfoRequest))
	}
