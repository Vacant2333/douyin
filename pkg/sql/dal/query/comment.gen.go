...
func newComment(db *gorm.DB, opts ...gen.DOOption) comment {
	...
	_comment.VideoID = field.NewUint(tableName, "video_id")
	_comment.CreateTime = field.NewTime(tableName, "create_time")
	_comment.Removed = field.NewUint(tableName, "removed")
	_comment.Deleted = field.NewUint(tableName, "deleted")
...
func (c *comment) updateTableName(table string) *comment {
	...
	c.VideoID = field.NewUint(table, "video_id")
	c.CreateTime = field.NewTime(table, "create_time")
	c.Removed = field.NewUint(table, "removed")
	c.Deleted = field.NewUint(table, "deleted")
...
type ICommentDo interface {
	...
	FindAll() (result []model.Comment, err error)
	FindById(id uint) (result model.Comment, err error)
	FindByRemoved(removed uint) (result []model.Comment, err error)
	FindByUserId(userId uint) (result []model.Comment, err error)
	FindByVideoId(videoId uint) (result []model.Comment, err error)
	FindNewerThanCreateTime(createTime *time.Time)
	FindByDeleted(deleted uint) (result []model.Comment, err error)
}

// sql(select * from @@table)
func (c commentDo) FindAll() (result []model.Comment, err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("select * from comment ")
...
func (c commentDo) FindByRemoved(removed uint) (result []model.Comment, err error) {
	var params []interface{}
...
func (c commentDo) FindByUserId(userId uint) (result []model.Comment, err error) {
	var params []interface{}
...
func (c commentDo) FindByVideoId(videoId uint) (result []model.Comment, err error) {
	var params []interface{}
...
func (c commentDo) FindNewerThanCreateTime(createTime *time.Time) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, createTime)
	generateSQL.WriteString("create_time >= ? ")

	var executeSQL *gorm.DB
	executeSQL = c.UnderlyingDB().Where(generateSQL.String(), params...) // ignore_security_alert
	_ = executeSQL
...
func (c commentDo) FindByDeleted(deleted uint) (result []model.Comment, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, deleted)
	generateSQL.WriteString("deleted=? ")
