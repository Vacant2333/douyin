...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.Enable = field.NewUint(tableName, "enable")
	_user.Type = field.NewUint(tableName, "type")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Enable = field.NewUint(table, "enable")
	u.Type = field.NewUint(table, "type")
...
type IUserDo interface {
	...
	FindByRemoved(removed uint) (result []model.User, err error)
	FindByUsernmae(username string) (result []model.User, err error)
	FindByType(theType uint) (result []model.User, err error)
	FindByEnable(enable uint) (result []model.User, err error)
}
...
func (u userDo) FindByRemoved(removed uint) (result []model.User, err error) {
	var params []interface{}
...
func (u userDo) FindByUsernmae(username string) (result []model.User, err error) {
	var params []interface{}
...
// Where("type=@theType")
func (u userDo) FindByType(theType uint) (result []model.User, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, theType)
	generateSQL.WriteString("type=? ")
...
// Where("enable=@enable")
func (u userDo) FindByEnable(enable uint) (result []model.User, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, enable)
	generateSQL.WriteString("enable=? ")
