...
func newFollow(db *gorm.DB, opts ...gen.DOOption) follow {
	...
	_follow.ID = field.NewUint(tableName, "id")
	_follow.UserID = field.NewUint(tableName, "user_id")
	_follow.FunID = field.NewUint(tableName, "fun_id")
	_follow.Removed = field.NewUint(tableName, "removed")
	_follow.Msg = field.NewString(tableName, "msg")
...
func (f *follow) updateTableName(table string) *follow {
	...
	f.FunID = field.NewUint(table, "fun_id")
	f.Removed = field.NewUint(table, "removed")
...
type IFollowDo interface {
	...
	FindAll() (result []model.Follow, err error)
	FindById(id uint) (result model.Follow, err error)
	FindByRemoved(removed uint) (result []model.Follow, err error)
	FindFolloweesByUserId(userId uint) (result []model.Follow, err error)
	FindFollowersByUserId(userId uint) (result []model.Follow, err error)
}

// sql(select * from @@table)
func (f followDo) FindAll() (result []model.Follow, err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("select * from follow ")
...
// Where("id=@id")
func (f followDo) FindById(id uint) (result model.Follow, err error) {
...
func (f followDo) FindByRemoved(removed uint) (result []model.Follow, err error) {
	var params []interface{}
...
func (f followDo) FindFolloweesByUserId(userId uint) (result []model.Follow, err error) {
	var params []interface{}
...
// Where("fun_id=@userId")
func (f followDo) FindFollowersByUserId(userId uint) (result []model.Follow, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, userId)
	generateSQL.WriteString("fun_id=? ")
