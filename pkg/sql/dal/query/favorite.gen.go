...
func newFavorite(db *gorm.DB, opts ...gen.DOOption) favorite {
	...
	_favorite.Removed = field.NewUint(tableName, "removed")
...
type IFavoriteDo interface {
	...
	FindAll() (result []model.Favorite, err error)
	FindById(id uint) (result model.Favorite, err error)
	FindByRemoved(removed uint) (result []model.Favorite, err error)
	FindByUserId(userId uint) (result []model.Favorite, err error)
	FindByVideoId(videoId uint) (result []model.Favorite, err error)
}

// sql(select * from @@table)
func (f favoriteDo) FindAll() (result []model.Favorite, err error) {
	var generateSQL strings.Builder
	generateSQL.WriteString("select * from favorite ")
...
// Where("id=@id")
func (f favoriteDo) FindById(id uint) (result model.Favorite, err error) {
...
func (f favoriteDo) FindByRemoved(removed uint) (result []model.Favorite, err error) {
	var params []interface{}
...
func (f favoriteDo) FindByUserId(userId uint) (result []model.Favorite, err error) {
	var params []interface{}
...
func (f favoriteDo) FindByVideoId(videoId uint) (result []model.Favorite, err error) {
	var params []interface{}
